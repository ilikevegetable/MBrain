...
from criterion.downstream_task_criterion import LinearClassifier, NewDownstreamCriterion
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ssl_dir', type=str, default='/data/caidonghong/nips22/rebuttal/MBrain_02GJX_l1_03_l2_04/',
