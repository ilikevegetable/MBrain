...
if __name__ == '__main__':
    ...
    parser.add_argument('--graph_threshold', type=float, default=0.5,
                        help='The threshold to sample edges in graph construct module:'
                             '01TGX: 0.1; 02GJX: 0.2; 03ZXY: 0.1; 05ZLH: 0.15; 06ZYJ: 0.1')
    ...
    parser.add_argument('--save_dir', type=str, default='/data/caidonghong/nips22/rebuttal/cross_patients/01_02_03/',
                        help='The path for saving checkpoint.')
    # load dataset setting
    parser.add_argument('--patients', type=str, nargs='+', default=['01TGX', '02GJX', '03ZXY'],
    ...
    ########################### load checkpoint ###########################
    # state_dict = torch.load('/data/caidonghong/nips22/MBrain_03ZXY_0508/checkpoint_120.pt', 'cpu')
    ...
    val_loader = val_dataset.get_cross_data_loader(args.batch_size, num_workers=0)
